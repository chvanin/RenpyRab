...
screen navigation():
    vbox:
        ...
        if main_menu:
            textbutton _("Путешествие") action Start() text_style "main_menu_button_style"
            textbutton _("Продолжить") action ShowMenu("load") text_style "main_menu_button_style"
            textbutton _("Настройки") action ShowMenu("preferences") text_style "main_menu_button_style"
            textbutton _("О игре") action ShowMenu("about") text_style "main_menu_button_style"
            
            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
                textbutton _("Справка") action ShowMenu("help") text_style "main_menu_button_style"
                
            if renpy.variant("pc"):
                textbutton _("Во тьму") action Quit(confirm=not main_menu) text_style "main_menu_button_style"
        else:
            textbutton _("История") action ShowMenu("history")
            textbutton _("Продолжить") action ShowMenu("save")
            ...
            if renpy.variant("pc"):
                textbutton _("Во тьму") action Quit(confirm=not main_menu)
